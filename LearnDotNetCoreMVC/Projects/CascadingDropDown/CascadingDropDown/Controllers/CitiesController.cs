...
namespace CascadingDropDown.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public CitiesController(DependentDropdownContext context)
        {
            _context = context;
        }
        ...
        {
            var dependentDropdownContext = _context.Cities.Include(c => c.State);
            return View(await dependentDropdownContext.ToListAsync());
        }
